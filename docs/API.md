...
```json
{
  ...
  "data": {
    "stats": {
      ...
      "totalProducts": 487,
      "totalOrders": 3201,
      "totalRevenue": 248590.50,
      "pendingOrders": 23,
      "lowStockProducts": 8,
      "today": { "orders": 45, "revenue": 5230.00 },
      "week": { "revenue": 28500.00 },
      "month": { "revenue": 124500.00 }
    }
  }
}
```
...
### Audit Logs
```http
GET /api/admin/activity?action=APPROVE_PAYMENT&page=1
Authorization: Bearer <admin_token>
```
...
{
  "title": "Flash Sale!",
  "message": "50% off everything for 24 hours",
  "type": "promotion"
}
```
